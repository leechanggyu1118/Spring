...
import com.ctc.wstx.shaded.msv_core.reader.GrammarReader.BackPatch;
...
public class FileSweeper {
	...
	private final String BASE_PATH ="C:\\leechanggyu\\_myProject\\_java\\_fileUpload\\";
	...
	public void fileSweeper() {
		...
		for(FileVO fvo : dbList) {
			...
			if(fvo.getFileType() > 0) {
				currFiles.add(BASE_PATH+filePath+"th"+fileName);
			}
		}
